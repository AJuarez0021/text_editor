...
BOOL CPrint::PrintFile (HINSTANCE hInst, HWND hWnd, HWND hEdit) //, PTSTR szFileName,UINT uID)
{
     ...
     //SetDlgItemText (hDlgPrint, uID, szFileName) ;
                         ...
                         for (iLine = 0 ; iLine < iLinesPerPage ; iLine++)
                         {
                              ...
                              *(int *) pstrBuffer = iCharsPerLine ;
                              ...
                              TextOut (pd.hDC, 0, yChar * iLine, pstrBuffer,
                                       (int) SendMessage (hEdit, EM_GETLINE,
